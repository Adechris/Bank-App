...
const Header = () =>{
    ...
    <Container fluid='md'>
      ...
      <Container>
        <Navbar.Brand as={Link} to="/" > <span className='home'>SILVERBIRD BANK</span></Navbar.Brand>
      ...
      <Container>
          ...
          <Nav className="me-end">
            ...
            <Nav.Link as={Link}  to="/deposit"><span className='text-white'><FaRegCreditCard/></span> <span className='list-item '>Withdraw</span></Nav.Link>
